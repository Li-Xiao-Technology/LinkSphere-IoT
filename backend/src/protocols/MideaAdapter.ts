/**
 * ⚠️ 注意：此适配器为演示实现，未接入真实美的美居 API。
 * 如需真实接入，需实现美的开放平台认证和 API 调用。
 */
import { ProtocolAdapter, Device, DeviceState } from '../types';

export class MideaAdapter implements ProtocolAdapter {
  brand = 'midea';
